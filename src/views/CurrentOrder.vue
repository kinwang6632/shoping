  ...
  <div class="mx-auto w-75 h-75 p-5 ">
    ...
    <div v-if ="true" class="overflow: auto">
      <table class="table w-100 mx-auto table-hover">
        <thead>
          <tr>
            <th scope="col" class="text-center text-secondary" style="width: 50px">#</th>
            <th scope="col" style="width: 120px " class="text-secondary"></th>
            <th scope="col" style="widht: 250px " class="text-secondary">型號</th>
            <th scope="col" style="widht: 150px " class="text-secondary">價格</th>
            <th scope="col" style="width: 250px" class="text-center text-secondary">
              訂購數量
            </th>
            <th scope="col" class="text-center text-secondary" style="width: 200px">
              取消訂購
            </th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="(data,index) in showOrdProducts" :key="index">
            ...
            <td class="align-middle"> 
              ...
              <div v-if="data.maxQuantity === 0" class="text-danger text-center pt-2" >*已達庫存量</div>
            </td>
            <td class="align-middle">
              <div
                class="
          ...
          <tr>
            ...
            <td scope="col" class="text-center text-secondary" style="width: 200px">
              ...
              <div class="w-100 h-100">
                  <button type="button" class="btn btn-outline-success w-100">確認訂單</button>
              </div>
              <div class="w-100 h-100 mt-2">
                  <button type="button" class="btn btn-outline-danger w-100">取消訂單</button>
              </div>
